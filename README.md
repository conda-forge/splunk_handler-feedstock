About splunk_handler-feedstock
==============================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/splunk_handler-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=3586&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/splunk_handler-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `splunk_handler` can be installed with `conda`:
...
```
mamba install splunk_handler
```

It is possible to list all of the versions of `splunk_handler` available on your platform with `conda`:
...
```
mamba search splunk_handler --channel conda-forge
```
...
mamba repoquery search splunk_handler --channel conda-forge

# List packages depending on `splunk_handler`:
mamba repoquery whoneeds splunk_handler --channel conda-forge

# List dependencies of `splunk_handler`:
mamba repoquery depends splunk_handler --channel conda-forge
```
